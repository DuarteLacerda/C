...
const char *gengetopt_args_info_usage = "Usage: executable_name [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --filename=STRING  ficheiro de texto a ser processado",
  "  -o, --option=STRING    carácter a ser substituído (opcional)",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->option_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->option_arg));
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* ficheiro de texto a ser processado.  */
          ...
          break;
        case 'o':	/* carácter a ser substituído (opcional).  */
        
        
          if (update_arg( (void *)&(args_info->option_arg), 
               &(args_info->option_orig), &(args_info->option_given),
              &(local_args_info.option_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "option", 'o',
              additional_error))
            goto failure;
